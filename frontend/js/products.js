...
orderForm.addEventListener("submit", async function(e){
    ...
    if(quantity>stock){
        alert("Only "+stock+" "+selectedProduct.unit+" available.");
        return;
    }
    ...
    const order={
        ...
        total_price:Number(totalInput.value)
...
productForm.addEventListener("submit",async function(e){
    ...
    const product={
        ...
        image:"images/"+document.getElementById("productImage").value.trim()
...
function editProduct(id){
    ...
    document.getElementById("productImage").value=product.image.replace("images/","");
